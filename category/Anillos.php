...
<div class="text-center m-4"><h4 class="f-7 text-uppercase">Selecciona Tus Anillos Favoritos</h4></div>
	...
	<!-- Main Content -->
		...
		<div class="row mt-2">
			...
			<div class="col-md-3">
                ...
                <p class="list-price old-price">Precio: <s><?php echo $product['listPrice']; ?></s></p>
				<p class="price">Nuestro Precio: <?php echo $product['price']; ?></p>
				<button type="button" class="btn btn-sm btn-info mb-2" onclick="detailsmodal(<?php echo $id = $product['productID']; ?>)">Detalles</button>
			</div>
			</div>
        <?php endforeach; ?>
		</div>
