        ...
        <?php else: ?>
            ...
            <div id="cart_footer" class="float-right mb-4">
                ...
                <div class="clearfix"></div>
                    ...
                    <div>
                    <button type="submit" name="updatecart" class="btn btn-primary"> Actualizar Carrito </button>
                    <button type="submit" name="checkout" class="btn btn-primary "> Verificar </button>
