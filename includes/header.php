...
<nav class="navbar navbar-expand-lg navbar-dark">
  <a class="navbar-brand" href="<?php echo ACCOUNT_URL;?>logout.php">AURORA COLLECTION</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo ACCOUNT_URL;?>aboutus.php">Sobre Nosotros <span class="sr-only"></span></a>
      </li>
    ...
    <div class="form-inline my-2 my-lg-0">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="<?php echo ACCOUNT_URL;?>myaccount.php">Perfil</a>
          <a class="dropdown-item" href="<?php echo ACCOUNT_URL;?>myorders.php">Mis Compras</a>
          <a class="dropdown-item" href="<?php echo ACCOUNT_URL;?>logout.php">Cerrar Sesion</a>
        </div>
      </li>
      <li  class="nav-item active">
